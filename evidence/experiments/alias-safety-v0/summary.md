...
Drupal inspection? Both arms get the same task, same substrate, and the same definition of
"unsafe" (including latent disabled-view claims). Only the tooling differs.
