...
def render_report(run_results: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "",
        "Put differently: Drush-only agents incorrectly judged hidden path claims as safe in roughly 20-30% of hidden disabled-View path judgments. With site self-description through `site-architecture:path-owner`, we observed 0 such misses in the headline run.",
        "",
